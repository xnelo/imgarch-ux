...
export async function GetTagsForFile(fileId: number, groupId?:number): Promise<FilearchTag[] | null> {
  ...
  return await GetAllTagsOnFile(session.access_token, fileId, groupId);
}